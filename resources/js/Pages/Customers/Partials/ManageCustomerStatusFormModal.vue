         ...
         <div class="flex flex-col mx-8 mb-2 space-y-2">
            <div class="basis-1 grow space-y-2">
               ...
               <div class="pt-4 pb-10 space-y-3 bg-white rounded-md border-none border-0">
                  <div>
                     <label for="title" class="text-md font-semibold text-black-900">
                        Title
                     </label>
                     <input v-model="form.title" type="text" id="title" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
